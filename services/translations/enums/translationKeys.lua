...
local this = {
    ...
    mcmDifficultyCategorySkill = "mcm.difficulty.category.skill",
    mcmDifficultyLabelPickBreakSkillGain = "mcm.difficulty.label.pickBreakSkillGain",
    mcmDifficultyDescPickBreakSkillGain = "mcm.difficulty.desc.pickBreakSkillGain",
    ...
    mcmHeaderBlacklist = "mcm.header.blacklist",
    mcmBlacklistDesc = "mcm.blacklist.desc",
    mcmBlacklistFilterLockpicks = "mcm.blacklist.filter.lockpicks",
    mcmBlacklistLabelIgnored = "mcm.blacklist.label.ignored",
    mcmBlacklistLabelUsed = "mcm.blacklist.label.used",
